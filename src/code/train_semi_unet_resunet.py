    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 500 == 0:
                ...
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_resunet/image_{iter_num}.png",np.transpose(image_save.data.cpu().numpy(),(1,2,0)))
                ...
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_resunet/outputs1_{iter_num}.png",img1_outputs.data.cpu().numpy())
                ...
                print(f'test_output shape: {test_output.shape}')
                print(f'img_tensor shape: {img_tensor.shape}')
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_resunet/outputs2_{iter_num}.png",img2_outputs.data.cpu().numpy())
                ...
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_resunet/labs_{iter_num}.png",np.transpose(labs_tensor.data.cpu().numpy(),(1,2,0)))
