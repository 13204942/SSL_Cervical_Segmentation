...
from networks.efficientunet import Effi_UNet as EffUnet
...
def train(args, snapshot_path):
    ...
    model2 = EffUnet('efficientnet-b3', encoder_weights='imagenet', in_channels=3, classes=args.num_classes, decoder_attention_type="scse").cuda()
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs2_emb = model2.encoder(volume_batch)[-1]
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    ...
                    preds_2 = model2(volume_valbatch)                    
            ...
            if iter_num % 500 == 0:
                ...
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_effunet/image_{iter_num}.png",np.transpose(image_save.data.cpu().numpy(),(1,2,0))) 
                ...
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_effunet/outputs1_{iter_num}.png",img1_outputs.data.cpu().numpy())
                ...
                print(f'test_output shape: {test_output.shape}')
                print(f'img_tensor shape: {img_tensor.shape}')
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_effunet/outputs2_{iter_num}.png",img2_outputs.data.cpu().numpy())
                ...
                cv2.imwrite(f"/root/autodl-tmp/assets_unet_effunet/labs_{iter_num}.png",np.transpose(labs_tensor.data.cpu().numpy(),(1,2,0)))
