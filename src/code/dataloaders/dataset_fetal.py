...
class BaseDataSets_Fetal(Dataset):
    def __init__(
        ...
        # autodl-tmp/Mamba-UNet/data/Fetal/train.list
        if self.split == "train":
            with open(self._base_dir + "/Mamba-UNet/data/Fetal/train.list", "r") as f1:
                self.sample_list = f1.readlines()
            self.sample_list = [item.replace("\n", "") for item in self.sample_list] 
        elif self.split == "val":
            with open(self._base_dir + "/Mamba-UNet/data/Fetal/val.list", "r") as f:
    ...
    def __getitem__(self, idx):
        ...
        try:
            if self.split == "train":
                # _base_dir = '/root/autodl-tmp/fetal_semi'
                if self.islabeled:
